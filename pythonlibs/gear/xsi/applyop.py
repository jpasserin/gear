...
def gear_zipper_op(crv0, crv1):
    ...
    paramDefs.append(XSIFactory.CreateParamDef("method", c.siInt4, 0, c.siPersistable|c.siAnimatable, "", "", 0, 0, 1, 0, 1))
    ...
    layout.AddEnumControl("method", ["Points", 0, "Percentage", 1], "Type", c.siControlCombo)
